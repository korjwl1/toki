...
impl ClaudeCodeParser {
    ...
    /// Returns the common `providers::ColdStartParsed` with `ProviderTokenData::ClaudeCode`.
    pub fn parse_for_cold_start(&self, line: &str) -> Option<crate::providers::ColdStartParsed> {
        let parsed = self.parse_line_common(line)?;
